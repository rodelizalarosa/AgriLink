...
import { Plus, Leaf, Loader2, AlertCircle, X, CheckCircle2, Image as ImageIcon, Info, ChevronRight, LayoutGrid } from 'lucide-react';
...
const AddProductModal: React.FC<AddProductModalProps> = ({ isOpen, onClose, onSuccess }) => {
    ...
    // Robust Reset: Clear state whenever modal opens or closes
    React.useEffect(() => {
        if (!isOpen) {
            setFormData({
                name: '',
                                ...
                                {imagePreview ? (
                                    ...
                                    <div className="flex flex-col items-center justify-center text-center p-10">
                                        ...
                                        <p className="text-[11px] font-black text-gray-400 uppercase tracking-widest leading-relaxed">
                                            Attach High-Resolution <br /> Harvest Photos
                                        </p>
                                    </div>
                                )}
                            </div>
